...
namespace OnlineSuperMartket.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
                ...
                var p = db.Products.Where(x => x.category_ID == id && x.is_active == true && x.is_deleted == false && x.stock > 0).ToList();
                ViewBag.prodts = p;
        ...
        public ActionResult customerAfterPurchase()
        {
            ...
            var p = db.Products.Where(x => x.is_active == true && x.is_deleted == false && x.stock > 0).ToList();
            ViewBag.prodts = p;
            //ViewBag.pageName = a.category_name;
